...
class SRResNet(nn.Module):
    ...
    def __init__(self,num_channels=10):
        ...
        #卷积模块1
        self.conv1 = nn.Conv2d(num_channels,64,kernel_size=9,padding=4,padding_mode='reflect',stride=1)
        self.relu = nn.PReLU()
        #残差模块
        ...
        self.finConv = nn.Conv2d(64,num_channels,kernel_size=9,stride=1)
